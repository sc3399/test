...
// start of Linkedin API
  ...
  //===============personality match================
  // if (myData[0].toJSON().about != null &&
  //       data.toJSON().about != null){
  //     var myAbout = myData[0].toJSON().about;
  //     var herAbout = data.toJSON().about;
  //
  //     personality(myAbout, function(err,score1){
  //       if (!err){
  //         personality(herAbout, function(err,score2){
  //           if (!err){
  //             var oldscore = score;
  //             score += Math.round(20*Math.abs(score1-score2));
  //             console.log("=======================");
  //             console.log(myAbout);
  //             console.log(herAbout);
